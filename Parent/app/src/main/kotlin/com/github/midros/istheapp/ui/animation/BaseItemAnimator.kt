...
abstract class BaseItemAnimator : SimpleItemAnimator() {
    ...
    internal var mInterpolator: Interpolator = DecelerateInterpolator()
    ...
    internal fun getRemoveDelay(holder: RecyclerView.ViewHolder): Long {
    ...
    internal fun getAddDelay(holder: RecyclerView.ViewHolder): Long {
    ...
    protected inner class DefaultAddAnimatorListener(private var mViewHolder: RecyclerView.ViewHolder) : Animator.AnimatorListener {
    ...
    protected inner class DefaultRemoveAnimatorListener(private var mViewHolder: RecyclerView.ViewHolder) : Animator.AnimatorListener {
